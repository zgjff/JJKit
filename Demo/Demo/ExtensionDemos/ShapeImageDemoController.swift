...
//        iv18.frame = iv15.frame
        ...
        iv32.image = UIImage.shape(.arrowCircleFill(.right, 4, .jRandom()), size: 40, tintColor: .jRandom())
        ...
        iv35.image = UIImage.shape(.arrowCircleFill(.up, 4, .jRandom()), size: 40, tintColor: .jRandom())
